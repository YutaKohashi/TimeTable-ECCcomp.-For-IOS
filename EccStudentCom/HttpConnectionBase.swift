...
//                ToolsBase().showToast("ログイン画面へのアクセスに失敗しました", isShortLong: true)
//                return;
//            }
//            
//            /*********************** ログイン画面　*****************************************
...
////                    self.hideIndicator(uiView)
//                    ToolsBase().showToast("ログインに失敗しました", isShortLong: true)
//                    return;
//                }
//                
//                
...
////                        self.hideIndicator(uiView)
//                        ToolsBase().showToast("出席率画面へのアクセス失敗しました", isShortLong: true)
//                        return;
//                    }
//                    
//                    
